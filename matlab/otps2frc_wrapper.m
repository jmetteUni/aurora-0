...
gfile= fullfile('/home/jonathan/Dokumente/model/roms_project/aurora-0/Data/',strcat(gridname,'.nc'));   %grid file
base_date=datenum(2022,07,26);
pred_date=datenum(2022,07,26);      %ref for nodal corrections; meaning??
ofile= fullfile('/home/jonathan/Dokumente/model/roms_project/aurora-0/Data/',strcat(gridname,'_tides','.nc'));    %output file name
